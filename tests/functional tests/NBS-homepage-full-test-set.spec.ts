...
test("1 Validate the I'm a manufacturer button features", async ({
  dysonPage,
}) => {
...
test("3 validate app view container contents and order", async ({
  dysonPage,
  page,
}) => {
...
test("4 Test login via sign in button and same page confirmation", async ({
  dysonPage,
  page,
}) => {
...
test("5 Verify back to top button functionality", async ({
  dysonPage,
  page,
}) => {
...
test("6 Dyson manufacturer page Accessibility test", async ({
  dysonPage,
  page,
}) => {
...
test("7 Verify API content and UI display", async ({ dysonPage, page }) => {
